...
JAVA_CONFIG=-Xss4m
MAVEN_HOME=/home/jonat/.m2
DATASPREAD_HOME=d:/Code/dataspread/dataspread-web

TEST_HOME=d:/Code/dataspread/FormulaCompressionTest/Jonathan/BasicTest
...
declare -a rows=("10000" "300000" "300000")
...
do
	...
	do
		...
		do
			...
			now="$(date)"
			echo "$now: Finished testing ${spreadsheetString[$j]} for ${depTableClassString[$i]}" >> out.log
			echo "" >> out.log
		done
	done
done
