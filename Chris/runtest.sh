...
# Sets current working directory to root of the machine to avoid relative / absolute path errors
cd

JAVA_HOME=C:/Progra~1/Java/jdk-16.0.1
	...
	do
		...
		do
			...
			$JAVA_CMD $JAVA_CONFIG \
				-Durl=jdbc:postgresql://127.0.0.1:5432/dataspread_db \
